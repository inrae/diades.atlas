...
<div id="TOC">
<ul>
<li><a href="#comment-est-organisée-la-traduction">Comment est organisée
la traduction</a>
<ul>
<li><a href="#pour-le-front-end">Pour le front-end</a></li>
</ul></li>
<li><a href="#ajouter-une-nouvelle-langue">Ajouter une nouvelle
langue</a>
<ul>
<li><a href="#fichiers-à-modifier">Fichiers à modifier</a></li>
<li><a href="#fonctions-bdd">Fonctions bdd</a></li>
<li><a href="#côté-code-de-lapplication">Côté code de
l’application</a></li>
</ul></li>
<li><a href="#notes-pour-les-dévelopeurs">Notes pour les dévelopeurs</a>
<ul>
<li><a href="#comment-créer-un-nouvel-élément-traductible-dans-lui">Comment
créer un nouvel élément “traductible” dans l’UI</a></li>
<li><a href="#ajouter-une-bulle-daide-traduisible">Ajouter une bulle
d’aide traduisible</a></li>
<li><a href="#comment-créer-un-nouvel-élément-traductible-dans-le-server">Comment
