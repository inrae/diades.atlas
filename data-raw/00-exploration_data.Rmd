...
```{r}
model_res <- get_hybrid_model_pl(species_id = c(6), scenario = 'rcp85', conn_eurodiad)


# load data included in `get_hybrid_model()`
debugonce(get_hybrid_model)
model_res <- get_hybrid_model(species_id = c(6), scenario = 'rcp85', lg = "fr", session = se)
# TODO il manque une étape hsi_min, ...
plot_hsi_nit(model_res, selected_year = 2000, selected_bv = c(14), withNitStandardisation = FALSE)
```
